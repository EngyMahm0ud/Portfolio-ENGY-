...
// Strategy Questions Animation and Interactions
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (rocketIcon) {
    setInterval(() => {
      rocketIcon.style.transform = 'rotate(45deg) scale(1.1)';
      setTimeout(() => {
        rocketIcon.style.transform = 'rotate(45deg) scale(1)';
      }, 200);
    }, 3000);
    
    rocketIcon.style.transition = 'transform 0.3s ease';
  }
  
  // List item animation
  const listItems = document.querySelectorAll('.strategy-card li');
